...
final class RetirementCalculatorUITests: XCTestCase {
    ...
    /* func testExample() throws {
        ...
        XCTContext.runActivity(named: "screenshot") { activity in
            ...
            //"resultLabel" is the accessibility identifier
            let resultText = app.staticTexts.element(matching: .any, identifier: "resultLabel")
            let result = "If you save $1000.0 every month for 35 years, and invest that money plus your current investment of 100000.0 at 3.0% annual interest rate, you will have $1000.0 by the time you are 65"
